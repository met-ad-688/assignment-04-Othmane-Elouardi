...
for group in pdf["Education_Group"].unique():
    ...
    plt.title(f"Salary vs. Experience — {group}")
    plt.xlabel("Max Years Experience (jittered)")
    plt.ylabel("Average Salary")
    plt.tight_layout()
    plt.show()

    explain(f"Salary vs. Experience — {group}", scatter_notes.get(group, [
...
for group in pdf["Education_Group"].unique():
    ...
    plt.title(f"Salary Distribution — {group}")
    plt.xlabel("Average Salary")
    plt.ylabel("Density")
    plt.tight_layout()
    plt.show()

    explain(f"Salary Distribution — {group}", hist_notes.get(group, [

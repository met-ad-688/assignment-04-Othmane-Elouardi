...
def note(title: str, lines: list[str]):
    ...
    print(f"📝 Appended analysis for: {title}")
...
for g in groups:
    ...
    plt.title(f"Salary vs. Experience — {g}")
    plt.xlabel("Max Years Experience (jittered)")
    plt.ylabel("Average Salary")
    plt.tight_layout()
    plt.show()

    title = f"Salary vs. Experience — {g}"
...
for g in groups:
    ...
    plt.title(f"Salary Distribution — {g}")
    plt.xlabel("Average Salary")
    plt.ylabel("Density")
    plt.tight_layout()
    plt.show()

    title = f"Salary Distribution — {g}"
